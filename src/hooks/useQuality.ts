...
const mapComplaint = (r: any): CustomerComplaint => ({
  ...
  responseRequired: r.response_required,
  responseDueDate: r.response_deadline,
  responseSentDate: r.responded_date,
  response: r.response_notes,
  resolutionStatus: r.resolved ? 'resolved' : (r.status === 'open' ? 'pending' : 'in_progress'),
  resolutionDate: r.resolved_date,
