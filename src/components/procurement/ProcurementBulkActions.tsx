...
interface Props { count: number; onExport: () => void; onDelete: () => void; onClear: () => void }

export default function ProcurementBulkActions({ count, onExport, onDelete, onClear }: Props) {
